  ...
  return (
    <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  md:p-3 '>
      {data?.map(({value,icon_url,id})=>{
        ...
        <div className='p-2  md:m-3 group box-shadow rounded-md group m-1 md:p-3 md:hover:text-teal-600   transition-all duration-200 ease-in transform cursor-pointer' >
