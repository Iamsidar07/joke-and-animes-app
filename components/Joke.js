  ...
  return (
    <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  md:p-3 '>
      {data?.map(({value,icon_url,id})=>{
        ...
        <div className='p-1 text-white md:m-3 group md:hover:bg-black/5 bg-[#1e293b] rounded-md group m-1 md:p-3   transition-all duration-200 ease-in transform cursor-pointer' >
        <p className='italic p-1 border-l-4 border-yellow-500'>{value}</p>
