...
function scrollFunction() {
  ...
  return (
    <div className={navbg?"bg-gray-900 w-full md:bg-slate-100 md:h-20 text-white  shadow-sm z-[10]   p-2 sticky top-0 left-0 right-0 md:transition-all ease-in md:duration-500":"bg-transparent md:h-20 text-white  shadow-sm z-[10]  w-full p-2 sticky top-0 left-0 right-0 md:transition-all ease-in md:duration-500"}>
