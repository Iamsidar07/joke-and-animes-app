...
const Intro = ({ pic, title, paragraph, isLeft, url, category, isBtn }) => {
  ...
  return (
    <div
      className={`bg-white md:hover:shadow-lg box-shadow md:box-shadow max-w-md  md:max-w-xl mx-auto md:px-10    mb-12 group  flex items-center   justify-content rounded-xl p-3 md:rounded-3xl flex-col  `} >
