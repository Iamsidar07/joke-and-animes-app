...
const Intro = ({ pic, title, paragraph, isLeft, url, category, isBtn }) => {
  ...
  return (
    <div
      className={`  box-shadow  md:shadow-none h-fit  ${isLeft?":md:flex-row":"md:flex-row-reverse"} mx-auto group  flex items-center  justify-between w-full px-2 md:p-12 flex-col-reverse md:flex-row mb-7 mt-7 md:m-0`} >
     
      <div className="bg-white py-2 md:p-5 w-full md:w-[45%]  flex flex-col items-center justify-start   space-y-2 ">
