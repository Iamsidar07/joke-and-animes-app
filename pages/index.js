  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="hero-bg h-72 z-[-10] mb-5">
          <div className="text-3xl  md:text-6xl h-full flex flex-col items-center justify-evenly w-full pt-5 ">
             <h1>Search,<span className="text-blue-500">Read</span> and Laugh</h1>
          </div>
        </div>
        <Fade bottom>
          <Intro
